...
export const mockPropsMap: Record<string, any> = {
  ...
  'Student/Feedback/Show': {
    student: {
      ...
      batch: 'Batch 2022-2026 (B.Tech COMP)',
      division: 'Division A',
    },
    feedbackItems: [
      {
        ...
        parameters: [
          { id: 'p1', label: 'Punctuality & Preparation', description: 'Faculty arrives on time and brings structured lecture outline' },
          { id: 'p2', label: 'Subject Command', description: 'Demonstrates deep mastery and answers questions effectively' },
          { id: 'p3', label: 'Teaching & Clarity', description: 'Explains complex ideas in an easy-to-understand manner' },
          { id: 'p4', label: 'Study Material Quality', description: 'Provides useful code notebooks, references, and slides' },
        ],
      },
      {
        assignmentId: 2,
        ...
        facultyName: 'Prof. Michael Chang',
